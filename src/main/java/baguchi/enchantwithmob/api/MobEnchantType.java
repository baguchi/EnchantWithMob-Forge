...
public record MobEnchantType(ResourceLocation texture, float expGainScale, Optional<ParticleOptions> particle) {
    public static final Codec<MobEnchantType> DIRECT_CODEC = RecordCodecBuilder
            .create(instance -> instance
                    .group(ResourceLocation.CODEC.fieldOf("texture")
