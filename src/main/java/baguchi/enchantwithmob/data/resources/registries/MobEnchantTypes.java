...
public class MobEnchantTypes {
    public static final ResourceKey<Registry<MobEnchantType>> MOB_ENCHANT_TYPE_REGISTRY_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(EnchantWithMob.MODID, "mob_enchant_type"));
    ...
    private static ResourceKey<MobEnchantType> createKey(String name) {
        return ResourceKey.create(MobEnchantTypes.MOB_ENCHANT_TYPE_REGISTRY_KEY, ResourceLocation.fromNamespaceAndPath(EnchantWithMob.MODID, name));
    }
    ...
    public static void bootstrap(BootstrapContext<MobEnchantType> context) {
        ...
        context.register(ANCIENT, new MobEnchantType(
                ResourceLocation.fromNamespaceAndPath(EnchantWithMob.MODID, "textures/entity/ancient_glint.png"),
                3F,
