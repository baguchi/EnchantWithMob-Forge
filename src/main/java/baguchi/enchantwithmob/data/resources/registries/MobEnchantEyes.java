...
public class MobEnchantEyes {
    ...
    public static Optional<Holder.Reference<MobEnchantEye>> getEyeVariant(RegistryAccess p_332694_, Holder<EntityType<?>> p_332773_) {
        Registry<MobEnchantEye> registry = p_332694_.lookupOrThrow(MOB_ENCHANT_EYE_REGISTRY_KEY);
        return registry.listElements()
                .filter(p_332674_ -> p_332674_.value().entityType().contains(p_332773_))
                .findFirst()
                .or(Optional::empty);
    }
}
