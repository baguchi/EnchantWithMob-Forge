...
public class ModArmorMaterials {
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(BuiltInRegistries.ARMOR_MATERIAL, EnchantWithMob.MODID);

    public static final Holder<ArmorMaterial> ENCHANTER_CLOTHES = register(
            "enchanter_clothes",
