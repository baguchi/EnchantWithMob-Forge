...
public class ModItems {
    ...
    public static final DeferredItem<Item> ENCHANTER_SPAWNEGG = ITEM_REGISTRY.register("enchanter_spawn_egg", () -> new SpawnEggItem(ModEntities.ENCHANTER.get(), (new Item.Properties().setId(prefix("enchanter_spawn_egg")))));
