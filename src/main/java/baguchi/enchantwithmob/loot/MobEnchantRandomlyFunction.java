...
public class MobEnchantRandomlyFunction extends LootItemConditionalFunction {
	...
	private static ItemStack enchantItem(ItemStack stack, Holder<MobEnchant> enchantment, RandomSource random) {
		...
		if (stack.is(Items.BOOK)) {
			stack = new ItemStack(ModItems.MOB_ENCHANT_BOOK.asItem());
		}
	...
	public static class Builder extends LootItemConditionalFunction.Builder<MobEnchantRandomlyFunction.Builder> {
		...
		public MobEnchantRandomlyFunction.Builder withMobEnchant(Holder<MobEnchant> enchantment) {
			this.options = Optional.of(HolderSet.direct(enchantment));
			return this;
		}

		public MobEnchantRandomlyFunction.Builder withOneOf(HolderSet<MobEnchant> enchantments) {
			this.options = Optional.of(enchantments);
			return this;
		}

		public MobEnchantRandomlyFunction.Builder allowingIncompatibleMobEnchants() {
